...
void CMyApp::Render1Plane(GLuint texture, glm::mat4 &trans)
{
	// Drawing 1 plane.
...
void CMyApp::Render()
{
	...
	Render1Plane(m_waterTextureID, trans);
	//m_textureID = GenTexture();
	trans = glm::mat4(1.0f)
		* glm::translate<float>(glm::vec3(-2, -2, 0));
	Render1Plane(m_textureID, trans);
	trans = glm::mat4(1.0f)
		* glm::rotate<float>(SDL_GetTicks() / 600.0, glm::vec3(0, 1, 0));//* glm::translate<float>(glm::vec3(2, 2, 0));
	Render1Plane(m_textureID, trans);
}
